...
fn main() -> ! {
   ...
   // let adc = adc::components::adc0(p. ADC0, &sc.power_control, (PE3<AnalogFunction>, pe2, pe1, pe0, pe5, pe4));
    ...
    //  let mut utp_adc = generic_adc_unit::new(tm4c_adc, pe3, pe2, pe1, pe0, pe5, pe4);
 	...
 	let mut tm4c_timer0 = Timer::<tm4c123x::TIMER0>::timer0(p.TIMER0, MillisU16(Millis(4)), &sc.power_control, &clocks);
 	let mut tm4c_timer1 = Timer::<tm4c123x::TIMER1>::timer1(p.TIMER1, MillisU16(Millis(4)), &sc.power_control, &clocks);
    ...
    utp_timer.set_state(TimerId::T1, TimerState::WithPeriod(core::num::NonZeroU16::new(6000).unwrap()));
